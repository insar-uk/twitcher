...
arecord -D plughw:Device_2,0 -f cd -t wav -s $s -r $fs -c 1 -q - | tee soundcard3.wav > /dev/null &
arecord -D plughw:Device_3,0 -f cd -t wav -s $s -r $fs -c 1 -q - | tee soundcard4.wav > /dev/null &
